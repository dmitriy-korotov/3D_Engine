...
{
	void basic_UICreator::putColorEdit4(const std::string_view& _title, glm::vec4& _color) const noexcept
	{
		LOG_WARN("[Basic UI Module WARN] Method 'putColorEdit4' is not overloaded");
	}
	void basic_UICreator::putSliderFloat(const std::string_view& _title, float& _value, float _min_val, float _max_val) const noexcept
	{
		LOG_WARN("[Basic UI Module WARN] Method 'putSliderFloat' is not overloaded");
	}
	void basic_UICreator::putSliderFloat2(const std::string_view& _title, glm::vec2& _value, float _min_val, float _max_val) const noexcept
	{
		LOG_WARN("[Basic UI Module WARN] Method 'putSliderFloat2' is not overloaded");
	}
	void basic_UICreator::putSliderFloat3(const std::string_view& _title, glm::vec3& _value, float _min_val, float _max_val) const noexcept
	{
		LOG_WARN("[Basic UI Module WARN] Method 'putSliderFloat3' is not overloaded");
	}
	void basic_UICreator::putSliderFloat4(const std::string_view& _title, glm::vec4& _value, float _min_val, float _max_val) const noexcept
	{
