...
namespace engine::ecs::systems
{
	...
	bool systems_creator::addCreator(std::string _system_name, creatorfn_t _creator_function) noexcept
	{
		return m_creators.emplace(std::move(_system_name), std::make_shared<creatorfn_t>(_creator_function)).second;
	}
