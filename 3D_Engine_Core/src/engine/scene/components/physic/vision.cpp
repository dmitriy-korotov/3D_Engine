...
namespace engine::scene::components
{
	...
	auto vision::setProjectionMode(Projection _projection_mode) noexcept -> void
	{
	...
	auto vision::setOrthographicFrustum(float _right_plane, float _top_plane, float _near_plane, float _far_plane, float _scale) noexcept -> void
	{
	...
	auto vision::setPrespectiveFrustum(float _fov, float _near_plane, float _far_plane) noexcept -> void
	{
	...
	auto vision::setViewPortSize(float _width, float _height) noexcept -> void
	{
	...
	auto vision::getProjectionMatrix() const noexcept -> const glm::mat4&
	{
	...
	auto vision::updateProjectionMatrix() const noexcept -> void
	{
	...
	auto vision::putOnUI() noexcept -> bool
	{
